...
![building-files](screenshots/2-build-up-files.png)

Step 2: Populated the files with necessary codes to build the portfolio page

![page-code](screenshots/3-code-snipet.png)


Step 3: Created and Pushed the code to a github repository.

![git-setup](screenshots/5-initialize-repo.png)

![git-upload](screenshots/4-git%20push.png)
